...
<body>
    <div class="container">
        ...
        <div class="instructions">
            <h3>📋 How to Play:</h3>
            <p>
                <strong>Player Control (Left Paddle):</strong><br>
                • Move your mouse vertically to control the left paddle<br>
                • Or use Arrow Keys (↑ Up / ↓ Down)<br>
                <br>
                <strong>Computer:</strong><br>
                • The right paddle is controlled by AI<br>
                <br>
                <strong>Objective:</strong><br>
                • Score points by making the ball pass your opponent's paddle<br>
    ...
    <script>
        ...
        function checkWinner() {
            if (player.score >= 11 || computer.score >= 11) {
                ...
                setTimeout(() => {
                    alert(`Game Over! ${winner} Wins! Final Score: ${player.score} - ${computer.score}`);
                }, 100);
            }
        }
